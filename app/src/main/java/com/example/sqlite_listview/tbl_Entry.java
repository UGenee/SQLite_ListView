...
public class tbl_Entry implements Serializable {
    public int entryId; public String entryTitle; public String content; public long date;

    public tbl_Entry() {
    }

    public tbl_Entry(String entryTitle, String content, long date) {
        this.entryTitle = entryTitle; this.content = content; this.date = date;
    }

    public tbl_Entry(int entryId, String entryTitle, String content, long date) {
        this.entryId = entryId; this.entryTitle = entryTitle; this.content = content; this.date = date;
    }
